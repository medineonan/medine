...
public class ArrayListRecap {
	...
	public static void main(String[] args) {
		...
		// lets ArratList that stores Double type of objects
		...
		//1. use advenced/enhanced for loop
		for(double a:alist) {
		...
		System.out.println("------Non genet=ric collection-----------");
		...
		obj.add(100);
		obj.add('c');
		obj.addAll(alist);// strore collection object
